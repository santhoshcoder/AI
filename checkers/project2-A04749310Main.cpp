...
int moveCount = 0;
int NodeCount = 0;
int NodeCountp1 = 0; // Player 1
int NodeCountp2 = 0;  // Player 2
double t1 = 0; // time taken by Player 1
double t2 = 0; // time taken by Player 2
int evalp1 = 0;
int evalp2 = 0;
int options;
...
void printEval()
{
	if(evalp2 == 0)
	{
		//It's computer vs user
		cout<< endl;
		cout<<"Evaluation function used by Computer 1 is: Eval "<<evalp1<<endl;
	}
	else
	{
		cout<< endl;
		cout<<"Evaluation function used by Computer 1 is: Eval "<<evalp1<<endl;
		cout<<"Evaluation function used by Computer 2 is: Eval "<<evalp2<<endl;
	}
}
class Node
{
...
int Node::utilityCount()
{
	...
	if((options == 1 && evalp1 == 2) || (options == 2 && evalp2 == 2))
	{
		/*
		cout<<endl<<"******"<<endl;
		cout<<"Options is:"<<options;
		cout<<"Evalp1 is:"<<evalp1;
		cout<<"Evalp2 is:"<<evalp2;
		//exit(0);
	 	*/
	 	for(int i=0;i<8;i++) 
	 	{
	...
	else if((options == 1 && evalp1 == 3) || (options == 2 && evalp2 == 3))
	{
		/*
		cout<<endl<<"******"<<endl;
		cout<<"Options is:"<<options;
...
void comVcomAB(char &player,int &row,int &column,int &nrow,int &ncolumn,bool &flag,bool &flag2,char board[][8],char newboard[][8])
{
	while(flag2)
	{
		bestPath.clear();
		...
		*/
		...
		NodeCountp1 += NodeCount;
		NodeCount = 0;
		if(test1.terminal())
		{
			cout<<"Length of Game Path:"<<moveCount<<endl;
			//cout<<"No of Nodes Generated:"<<NodeCount<<endl;
			cout<<"No of Nodes Generated by Computer 1:[MinMaxAB]"<<NodeCountp1<<endl;
			cout<<"No of Nodes Generated by Computer 2:[MinMaxAB]"<<NodeCountp2<<endl;
			cout<<"Time taken by Computer 1:[MinMaxAB]: "<<t1<<" microseconds"<<endl;
			cout<<"Time taken by Computer 2:[MinMaxAB]: "<<t2<<" microseconds"<<endl;
			printEval();
			int w = test1.utility();
			if(w == 20)
			{
...
void comVuserAB(char &player,int &row,int &column,int &nrow,int &ncolumn,bool &flag,bool &flag2,char board[][8],char newboard[][8])
{
	while(flag2)
	{
		bestPath.clear();
		...
		if(test1.terminal())
		{
			cout<<"Length of Game Path:"<<moveCount<<endl;
			//cout<<"No of Nodes Generated:"<<NodeCount<<endl;
			cout<<"No of Nodes Generated by Computer[MinMaxAB]:"<<NodeCountp1<<endl;
			//cout<<"No of Nodes Generated by User:"<<NodeCountp2<<endl;
			printEval();
			int w = test1.utility();
			if(w == 20)
			{
...
void alphaVab(char &player,int &row,int &column,int &nrow,int &ncolumn,bool &flag,bool &flag2,char board[][8],char newboard[][8])
{
	while(flag2)
	{
		options = 1;
		...
		test.move = 0;
		auto start = high_resolution_clock::now();
		Node comp1 = MinMaxAB(test,test.move,test.player,120,-100);
		auto stop = high_resolution_clock::now();
		auto duration = duration_cast<microseconds>(stop - start);
		t1 += duration.count();
		for(int k = bestPath.size() - 1;k>=0;k--)
		...
		if(test1.terminal())
		{
			...
			//cout<<"No of Nodes Generated:"<<NodeCount<<endl;
			cout<<"No of Nodes Generated by Computer 1 :[MinMaxAB]"<<NodeCountp1<<endl;
			cout<<"No of Nodes Generated by Computer 2:[Alpha-Beta-Search]"<<NodeCountp2<<endl;
			cout<<"Time taken by Computer 1:[MinMaxAB]"<<t1<<" microseconds"<<endl;
			cout<<"Time taken by Computer 2:[Alpha-Beta-Search]: "<<t2<<" microseconds"<<endl;
			printEval();
			int w = test1.utility();
			if(w == 20)
			{
...
void abValpha(char &player,int &row,int &column,int &nrow,int &ncolumn,bool &flag,bool &flag2,char board[][8],char newboard[][8])
{
	while(flag2)
	{
		...
		if(test1.terminal())
		{
			cout<<"Length of Game Path:"<<moveCount<<endl;
			//cout<<"No of Nodes Generated:"<<NodeCount<<endl;
			cout<<"No of Nodes Generated by Computer 1 [Alpha-Beta-Search]:"<<NodeCountp1<<endl;
			cout<<"No of Nodes Generated by Computer 2:[MinMaxAB]"<<NodeCountp2<<endl;
			cout<<"Time taken by Computer 1:[Alpha-Beta-Search]: "<<t1<<" microseconds"<<endl;
			cout<<"Time taken by Computer 2:[MinMaxAB]: "<<t2<<" microseconds"<<endl;
			printEval();
			int w = test1.utility();
			if(w == 20)
...
void comVuser(char &player,int &row,int &column,int &nrow,int &ncolumn,bool &flag,bool &flag2,char board[][8],char newboard[][8])
{
	while(flag2)
	{
		...
		if(test1.terminal())
		{
			cout<<"Length of Game Path:"<<moveCount<<endl;
			//cout<<"No of Nodes Generated:"<<NodeCount<<endl;
			cout<<"No of Nodes Generated by Computer:"<< NodeCountp1<<endl;
			printEval();
			int w = test1.utility();
			if(w == 20)
			{
...
int main()
{
	...
	*/
	...
	cout<<"1.Computer Vs User - Alpha-Beta-Search"<<endl;
	...
	int eval;
	cout<<"Choose one of the below evaluation function for computer 1"<<endl;
	cout<<"1.Eval 1"<<endl;
	cout<<"2.Eval 2"<<endl;
	cout<<"3.Eval 3"<<endl;
	do
	...
	switch(options)
	{
		...
		case 3:
				cout<<"Computer Turn...."<<endl;
				comVuserAB(player,row,column,nrow,ncolumn,flag,flag2,board,newboard);
				break;
		case 4:
				exit(0);
	}
	cout<<"Choose one of the below evaluation function for computer 2"<<endl;
	cout<<"1.Eval 1"<<endl;
	cout<<"2.Eval 2"<<endl;
	cout<<"3.Eval 3"<<endl;
	do
	...
	evalp2 = eval;
	cout<<"1.Computer 1 Vs Computer 2 - Alpha-Beta-Search"<<endl;
	cout<<"2.Computer 1 Vs Computer 2 - MinMaxAB"<<endl;
	cout<<"3.Alpha-Beta-Search Vs MinMaxAB"<<endl;
	cout<<"4.MinMaxAB Vs Alpha-Beta-Search"<<endl;
	cout<<"5.Exit"<<endl;
	cout<<"Choose one of the above options: ";
	do
	{
	...
	switch(options)
	{
		...
		case 2:
				...
				break;
		case 3:
				//alpha-beta search vs minmaxAB
				abValpha(player,row,column,nrow,ncolumn,flag,flag2,board,newboard);
				break;
		case 4:
				//MinmaxAB vs alpha-beta-search
				alphaVab(player,row,column,nrow,ncolumn,flag,flag2,board,newboard);
				break;
		case 5:
				exit(0);
	}
